...
2. Apply filters with error handling
3. Benchmark performance
4. Evaluate quality across 8 dimensions
5. Export results

Usage:
    python example_workflow.py <input_pcd> [output_dir]
"""
...
def main(input_pcd_path: str, output_dir: str = None):
    """
    Run complete filtering and evaluation pipeline.
    ...
    # ========== 4. EVALUATE QUALITY (if ground truth available) ==========
